...
import com.epam.digital.data.platform.bpms.api.dto.ProcessInstanceQueryDto;
...
class ProcessInstanceRestClientIT extends BaseIT {
  ...
  void getProcessInstances() {
    var processInstanceQuery = ProcessInstanceQueryDto.builder()
        .rootProcessInstances(true)
        .build();
    ...
    assertThat(result).hasSize(1)
        ...
        .hasFieldOrPropertyWithValue("state", ProcessInstanceStatus.PENDING);
  }
}
