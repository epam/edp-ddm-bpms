...
public class ProcessInstanceService {
   ...
   */
  public List<ProcessInstanceDto> getProcessInstancesByParams(
    ...
    var result = processInstanceMapper.tDdmProcessInstanceDtos(dtos, historicalProcessInstances,
  ...
  private Map<String, HistoricProcessInstance> getHistoricProcessInstances(
    ...
    var processInstanceIds = dtos.stream()
        .map(org.camunda.bpm.engine.rest.dto.runtime.ProcessInstanceDto::getId)
  ...
  private Map<String, String> getProcessDefinitionNames(
    ...
    var processDefinitionIds = dtos.stream()
        .map(org.camunda.bpm.engine.rest.dto.runtime.ProcessInstanceDto::getDefinitionId)
        .distinct()
        .toArray(String[]::new);
