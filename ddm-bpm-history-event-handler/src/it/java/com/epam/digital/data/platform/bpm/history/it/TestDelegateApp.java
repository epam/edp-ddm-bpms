...
import com.epam.digital.data.platform.bpm.history.DdmBpmHistoryAutoConfiguration;
...
@SpringBootApplication(scanBasePackages = {"com.epam.digital.data.platform.bpms.engine",
    "com.epam.digital.data.platform.bpm.history.it"})
@EnableAutoConfiguration
@ImportAutoConfiguration(classes = DdmBpmHistoryAutoConfiguration.class)
