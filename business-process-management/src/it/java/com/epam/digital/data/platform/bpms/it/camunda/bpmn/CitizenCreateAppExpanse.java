...
public class CitizenCreateAppExpanse extends BaseBpmnIT {

  private final String PROCESS_DEFINITION_ID = "citizen-create-app-expanse";
  ...
  public void init() {
    super.init();
    headOfficerToken = TestUtils.getContent("/json/citizen-create-expanse/headOfficerAccessToken.json");
    officerToken = TestUtils.getContent("/json/citizen-create-expanse/officerAccessToken.json");
    mockConnectToKeycloak(officerRealm);
  }

  @Test
  @Deployment(resources = "bpmn/citizen-create-app-expanse.bpmn")
  public void happyPath() throws JsonProcessingException {
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .response("/json/citizen-create-expanse/data-factory/subjectResponse.json")
        .build());
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .response("/json/citizen-create-expanse/data-factory/solutionTypeAddResponse.json")
        .build());
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .queryParams(Map.of("constantCode", "ADD"))
        .response(
            "/json/citizen-create-expanse/data-factory/applicationTypeResponse.json")
        .build());
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .response("/json/citizen-create-expanse/data-factory/lastLaboratorySolutionDeny.json")
        .build());
    stubDataFactoryRequest(StubData.builder()
        .httpMethod(HttpMethod.GET)
        .headers(Map.of("X-Access-Token", testUserToken))
        ...
        .resourceId(labId)
        .response(
            "/json/citizen-create-expanse/data-factory/labWithoutAccreditation.json")
        .build());
    stubDataFactoryRequest(StubData.builder()
        .httpMethod(HttpMethod.GET)
        .headers(Map.of("X-Access-Token", testUserToken))
    ...
    mockKeycloakGetUsersByRole("officer",
        "/json/citizen-create-expanse/keycloak/users-by-role-response.json");
    ...
    var sinResponseBody = addFiledToSignatureFormData(
        "/json/citizen-create-expanse/dso/primaryIncludeSystemSignatureRequest.json", "createdDate",
        createdDate);
    ...
    var responseBody = addFiledToJson(
        "/json/citizen-create-expanse/data-factory/createApplicationIncludeRequest.json",
    ...
    completeTask(citizenSharedAddFactors, processInstanceId,
        "/json/citizen-create-expanse/form-data/Activity_citizen-shared-add-factors.json");
    ...
    completeTask(citizenSharedSignFactors, processInstanceId,
        "/json/citizen-create-expanse/form-data/Activity_citizen-shared-sign-factors.json");
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .expectedFormData("/json/citizen-create-expanse/form-data/Activity_shared-dispatch-task.json")
        .build());

    var citizenSharedAddApplicationPrePopulation = deserializeFormData(
        "/json/citizen-create-expanse/form-data/Activity_citizen-shared-add-application-pre-population.json");
    ...
    var formDataAsString = addFieldToFormDataAndReturn(
        "/json/citizen-create-expanse/form-data/Activity_citizen-shared-add-application.json",
        "createdDate", createdDate);
    completeTask(CompleteActivityDto.builder()
        .processInstanceId(processInstanceId)
        .activityDefinitionId(citizenSharedAddApplication)
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-check-complience-pre-population.json"))
        .build());
    completeTask(CompleteActivityDto.builder()
        .processInstanceId(processInstanceId)
        .activityDefinitionId(citizenSharedCheckComplience)
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-check-complience.json")
        .build());
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-officer-sign-app.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-headofficer-check-complience-pre-population.json"))
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-headofficer-check-complience.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_shared-add-decision-include-pre-population.json"))
        .expectedVariables(
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_shared-add-decision-include.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-sign-app-include-pre-population.json"))
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-sign-app-include.json")
        .build());
  ...
  public void woConsiderFlowWithHeadOfficerAgreeFlagTrue() throws JsonProcessingException {
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .response("/json/citizen-create-expanse/data-factory/solutionTypeWoConsiderResponse.json")
        .build());
    stubDataFactoryRequest(StubData.builder()
        .httpMethod(HttpMethod.GET)
        .headers(Map.of("X-Access-Token", headOfficerToken))
    ...
    var sinResponseBody = addFiledToSignatureFormData(
        "/json/citizen-create-expanse/dso/primaryDenySystemSignatureRequest.json", "createdDate",
        createdDate);
    stubDigitalSignatureRequest(StubData.builder()
        .httpMethod(HttpMethod.POST)
        .headers(Map.of("X-Access-Token", headOfficerToken))
    ...
    var responseBody = addFiledToJson(
        "/json/citizen-create-expanse/data-factory/createApplicationDenyRequest.json",
        "createdDate", createdDate);
    stubDataFactoryRequest(StubData.builder()
        .httpMethod(HttpMethod.POST)
        .headers(Map.of("X-Access-Token", headOfficerToken))
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-check-complience-with-errors.json")
        .build());
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-officer-sign-app-with-errors.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .formKey("citizen-shared-headofficer-check-complience")
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-headofficer-check-complience-pre-population-with-errors.json"))
        .expectedVariables(Map.of(citizenSharedOfficerSignApp + "_completer", officerUserName))
        .build());
    completeTask(CompleteActivityDto.builder()
        .processInstanceId(processInstanceId)
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-headofficer-check-complience-with-errors.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .assignee(officerUserName)
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-check-complience-pre-population-comment.json"))
        .build());
    completeTask(CompleteActivityDto.builder()
        .processInstanceId(processInstanceId)
        .activityDefinitionId(citizenSharedCheckComplience)
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-check-complience-with-errors-without-approve.json")
        .build());
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(officerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-officer-sign-app-with-errors-without-approve.json")
        .build());
    /*approve flow ends*/
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_shared-add-decision-deny-pre-population.json"))
        .build());
    completeTask(CompleteActivityDto.builder()
        .processInstanceId(processInstanceId)
        .activityDefinitionId(sharedAddDecisionDeny)
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_shared-add-decision-deny.json")
        .build());
    ...
    CamundaAssertionUtil.assertWaitingActivity(AssertWaitingActivityDto.builder()
        ...
        .expectedFormDataPrePopulation(deserializeFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-sign-app-deny-pre-population.json"))
    ...
    completeTask(CompleteActivityDto.builder()
        ...
        .completerAccessToken(headOfficerToken)
        .expectedFormData(
            "/json/citizen-create-expanse/form-data/Activity_citizen-shared-sign-app-deny.json")
        .build());
  ...
  public void testAppAlreadyCreated() throws JsonProcessingException {
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .resource("last-laboratory-solution")
        .queryParams(Map.of("laboratoryId", labId))
        .response("/json/citizen-create-expanse/data-factory/last-laboratory-no-solution.json")
        .build());
    ...
    stubDataFactoryRequest(StubData.builder()
        ...
        .resource("application-type-equal-constant-code")
        .queryParams(Map.of("constantCode", "ADD"))
        .response("/json/citizen-create-expanse/data-factory/applicationTypeResponse.json")
        .build());
    ...
    Assertions.assertThat(errors.get(0)).contains(Map.entry("field", "laboratory"),
        Map.entry("message", "Відсутня заява на первинне внесення або створена заява на видалення з Реєстру"),
