...
public class CreateAppExcludeBpmnIT extends BaseBpmnIT {
  ...
  public void testHappyPath() throws IOException {
    ...
    //start process
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("create-app-exclude", new HashMap<>());
    String processInstanceId = processInstance.getId();

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("searchLabFormActivity");
    completeTask("searchLabFormActivity", processInstanceId, "/json/create-app-exclude/searchLabFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("addApplicationFormActivity");
    completeTask("addApplicationFormActivity", processInstanceId, "/json/create-app-exclude/addApplicationFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("checkComplianceFormActivity");
    completeTask("checkComplianceFormActivity", processInstanceId, "/json/create-app-exclude/checkComplianceFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("addDecisionExcludeFormActivity");
    completeTask("addDecisionExcludeFormActivity", processInstanceId, "/json/create-app-exclude/addDecisionExcludeFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("addLetterDataFormForExclusionActivity");
    completeTask("addLetterDataFormForExclusionActivity", processInstanceId, "/json/create-app-exclude/addLetterDataFormForExclusionActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("signAppExcludeFormActivity");
    completeTask("signAppExcludeFormActivity", processInstanceId, "/json/create-app-exclude/signAppExcludeFormActivity.json");
  ...
  public void testPathWithMistakes() throws IOException {
    ...
    BpmnAwareTests.assertThat(processInstance).isWaitingAt("checkComplianceFormActivity");
    completeTask("checkComplianceFormActivity", processInstanceId, "/json/create-app-exclude/noConsiderCheckComplianceFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("addDecisionDenyFormActivity");
    completeTask("addDecisionDenyFormActivity", processInstanceId, "/json/create-app-exclude/addDecisionDenyFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("addLetterDataFormForDenyActivity");
    completeTask("addLetterDataFormForDenyActivity", processInstanceId, "/json/create-app-exclude/addLetterDataFormForDenyActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("signAppDenyFormActivity");
    completeTask("signAppDenyFormActivity", processInstanceId, "/json/create-app-exclude/signAppDenyFormActivity.json");
