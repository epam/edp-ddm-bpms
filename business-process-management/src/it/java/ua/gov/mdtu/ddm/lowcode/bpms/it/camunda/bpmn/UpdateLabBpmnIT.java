...
public class UpdateLabBpmnIT extends BaseBpmnIT {
  ...
  public void test() throws IOException {
    ...
    //start process
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("update-lab", new HashMap<>());
    String processInstanceId = processInstance.getId();

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("searchLabFormActivity");
    completeTask("searchLabFormActivity", processInstanceId, "/json/update-lab/searchLabFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("viewLabDataFormActivity");
    completeTask("viewLabDataFormActivity", processInstanceId, "/json/update-lab/viewLabDataFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("updateLabFormActivity");
    completeTask("updateLabFormActivity", processInstanceId, "/json/update-lab/updateLabFormActivity.json");

    BpmnAwareTests.assertThat(processInstance).isWaitingAt("signLabFormActivity");
    completeTask("signLabFormActivity", processInstanceId, "/json/update-lab/signLabFormActivity.json");
