...
/**
 * The class represents an implementation of {@link BaseJavaDelegate} that is used to partially
 * update data in Data Factory
 */
@Slf4j
@RequiredArgsConstructor
@Component("dataFactoryConnectorPartialUpdateDelegate")
public class DataFactoryConnectorPartialUpdateDelegate extends BaseJavaDelegate {

  public static final String DELEGATE_NAME = "dataFactoryConnectorPartialUpdateDelegate";
  ...
  public void executeInternal(DelegateExecution execution) throws JsonProcessingException {
    ...
    log.debug("Start partially updating entity with id {} on resource {}", id, resource);
    ...
    var headers = headerBuilderFactory.builder()
        ...
        .accessTokenHeader()
        .build();
    var response = dataFactoryFeignClient.performPatch(resource, id, requestBody, headers);
