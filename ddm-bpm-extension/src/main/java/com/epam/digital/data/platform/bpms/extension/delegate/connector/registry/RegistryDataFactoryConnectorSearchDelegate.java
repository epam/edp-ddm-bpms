...
@Component(RegistryDataFactoryConnectorSearchDelegate.DELEGATE_NAME)
public class RegistryDataFactoryConnectorSearchDelegate extends BaseJavaDelegate {

  public static final String DELEGATE_NAME = "registryDataFactoryConnectorSearchDelegate";
  ...
  public void executeInternal(DelegateExecution execution) {
    ...
    log.debug("Start searching entities on resource {} in registry {}", resource, registry);
    ...
    var response = platformGatewayFeignClient.performSearch(registry, resource, searchConditions,
        headers);
