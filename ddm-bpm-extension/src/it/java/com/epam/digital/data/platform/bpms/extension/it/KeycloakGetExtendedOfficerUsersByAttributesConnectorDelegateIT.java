...
class KeycloakGetExtendedOfficerUsersByAttributesConnectorDelegateIT extends BaseIT {

  @Test
  @Deployment(resources = "bpmn/connector/testKeycloakGetExtendedOfficerUsersByAttributes.bpmn")
  void shouldGetOfficerUsersByAttributes() {
    ...
    var processInstance = runtimeService.startProcessInstanceByKey(
        "test_get_officers_by_attribute");
