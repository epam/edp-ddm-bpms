...
class DefineProcessBusinessKeyDelegateIT extends BaseIT {

  @ParameterizedTest(name = "{0}")
  @MethodSource("testArgumentProvider")
  @Deployment(resources = {"bpmn/delegate/businessKeyDelegateTestProcess.bpmn"})
  ...
  static Stream<Arguments> testArgumentProvider() {
    return Stream.of(
        arguments("businessKeyDelegateTestProcess_nullProcessKey", null),
        arguments("businessKeyDelegateTestProcess_longProcessKey", null),
        arguments("businessKeyDelegateTestProcess_validProcessKey", "businessKey")
    );
  }
}
