...
class SearchRegistryUsersByRoleAndAttributesDelegateIT extends BaseIT {

  @Test
  @Deployment(resources = "bpmn/connector/feature-search-registry-users-by-role-and-attributes.bpmn")
  void shouldGetOfficerUsersByRoleAndAttributes() {
    mockConnectToKeycloak(officerRealm);
    mockKeycloakSearchUsersByRoleAndAttributes(officerRealm,
        "/json/keycloak/searchOfficerUsersByRoleAndAttributesRequest.json",
        "/json/keycloak/searchOfficerUsersByRoleAndAttributesResponse.json");

    var processInstance = runtimeService.startProcessInstanceByKey(
        "feature-search-registry-users-by-role-and-attributes",
        Map.of(
            "isOfficer", true,
  ...
  void shouldGetCitizenUsersByAttributes() {
    ...
    mockKeycloakSearchUsersByRoleAndAttributes(citizenRealm,
        "/json/keycloak/searchOfficerUsersByRoleAndAttributesRequest.json",
        "/json/keycloak/searchOfficerUsersByRoleAndAttributesResponse.json");
