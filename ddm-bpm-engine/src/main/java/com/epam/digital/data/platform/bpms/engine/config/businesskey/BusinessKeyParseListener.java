...
/**
 * {@link AbstractBpmnParseListener} extension that is used for adding built in {@link
 * BusinessKeyExecutionListener} to start event for every top level process definition
 */
@RequiredArgsConstructor
public class BusinessKeyParseListener extends AbstractBpmnParseListener {

  private final BusinessKeyExecutionListener businessKeyExecutionListener;
